...
const FAQSection = () => {
    ...
    const faqs = [
        { question: '¿Por qué debería contratar a un estudiante?', answer: 'Contratar a un estudiante te permite flexibilidad...' },
        ...
        { question: '¿Cómo puedo comunicarme con mi estudiante contratado?', answer: 'Puedes comunicarte a través del chat integrado...' },
        ...
        { question: '¿Qué debo hacer si tengo problemas con un estudiante?', answer: 'Contáctanos a través de soporte para resolver cualquier conflicto...' },
        { question: '¿Puedo trabajar con estudiantes de habla hispana?', answer: 'Sí, en Busquidy puedes filtrar estudiantes por idioma.' }
    ];
