    ...
    <div className="space-y-6">
      ...
      <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-teal-800">
          Esta información ayuda a las empresas a encontrar profesionales que se ajusten a sus necesidades.
        </p>
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Renta Esperada (mensual en CLP) <span className="text-red-500">*</span>
        </label>
        <input
          type="number"
          name="renta_esperada"
        ...
        <p className="mt-2 text-sm text-gray-500">
          Ingresa el salario esperado mensualmente. Este dato es confidencial.
        </p>
      </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-6">
        ...
        <div className="space-y-2 text-sm text-gray-700">
          <p>
            ...
            {freelancerData.pretensiones.disponibilidad || "No especificada"}
          </p>
          <p>
            <span className="font-medium">Renta esperada:</span>{" "}
            {freelancerData.pretensiones.renta_esperada
              ? `$${freelancerData.pretensiones.renta_esperada.toLocaleString("es-CL")}`
              : "No especificada"}
          </p>
        </div>
      </div>
